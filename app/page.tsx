    ...
    <>
      ...
      <div className="mb-8">
        ...
        <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
          {"Hello! I'm Sean, a current student at UC Berkeley. I am passionate about solving problems, learning, and using my knowledge to benefit the world around me. I also have a strong foundation in pre-medical studies, having completed all the required pre-med courses. This diverse background allows me to bridge the gap between technology and life sciences, bringing a unique perspective to interdisciplinary projects. My interests lie in the power of Data, Computational Biology, and Software Development."}
        </p>
      </div>
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              date: "Mar 2024",
              description: [
                "Simulated a functional CPU that supports the RISC-V instruction set, using Logisim",
              ]
            },
            {
              title: "2048",
              date: "Sep 2023",
              description: [
                "Recreated the sliding-tile game 2048, using Java and other Object Oriented Programming essentials."
              ]
            },
            {
              ...
              date: "Jul 2023",
              description: [
                "Recreated Plants vs. Zombies in Python using OOP principles with a special emphasis on inheritance to design various game characters and scenarios."
              ]
            },
            {
              title: "Snake",
              date: "Jan 2024",
              description: [
                "Developed and implemented the logic of the popular game Snake, using the C programming language with manual memory allocation"
              ]
            }
          ].map((project, index) => (
